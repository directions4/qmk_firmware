...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------|   |------|------+------+------+------+------+------|
   * | Henk |Muhen |   Z  |   X  |   C  |   V  |  B   |   |  N   |   M  |   ,  |   .  |   /  | LEFT | RSft |
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
   * | META | SYMB |   `  |   \  | LAlt | LGUI |Space |   |Space |R_GUI | RAlt |   '  |  -   |   =  | APP  |
   * `------------------------------------------------'   `------------------------------------------------'
   */
  [BASE] = LAYOUT( \
    ...
    KC_HENK,  KC_MHEN,  KC_Z,   KC_X,    KC_C,    KC_V,     KC_B,   KC_N,   KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LEFT, KC_RSFT, \
    MO(META), MO(SYMB), KC_GRV, KC_BSLS, KC_LALT, KC_LGUI,  KC_SPC, KC_SPC, KC_RGUI, KC_RALT, KC_QUOT, KC_MINS, KC_EQL,  KC_APP \
  ),
   ...
   * |------+------+------+------+------+------+------|   |-------------+------+------+------+------+------|
   * | RSft |RCtrl |      |Muhen | Henk |      |  <-  |   |  ->  | Left | Down | Up   |Right |      | Enter|
   * |------+------+------+------+------+------+------|   |------|------+------+------+------+------+------|
   * |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  | HOME |   | END  |  F7  |  F8  |  F9  | F10  | F11  | F12  |
   * |------+------+------+------+------+------+------|   |------+------+------+------+------+------+------|
  ...
  [META] = LAYOUT( \
    ...
    KC_RSFT, KC_RCTL, XXXXXXX, KC_MHEN, KC_HENK, XXXXXXX, KC_LEFT,  KC_RGHT, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, XXXXXXX, _______, \
    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_HOME,  KC_END,  KC_F7,   KC_F8,   KC_F9, KC_F10,  KC_F11,  KC_F12, \
  ...
  [SYMB] = LAYOUT( \
    ...
    _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, S(KC_LBRC), S(KC_RBRC), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_UP,   _______, \
